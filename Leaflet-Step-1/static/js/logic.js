...
//Creates circles for longitude and lattitude. Increase radius property to control size of circle
//Circles were really small, so I multiplied by 5. Adjust as you please.
function setMarkerProperties(feature, latlng) {
...
d3.json(queryUrl, function (data) {
    ...
    var earthquakes = L.geoJSON(data.features, {
        ...
        pointToLayer: setMarkerProperties
    });
